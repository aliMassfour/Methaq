        ...
        <div class="col-12 mt-5">
            <center>
                <div class="bg-dark rounded-3 p-4 p-sm-5 position-relative w-50" dir="rtl">
                    ...
                    <h3 class="mb-3 text-white">تعديل معلومات الخدمة :</h3>
                    ...
                    <form action="{{ route('service.update',$service->id) }}" method="post"
                        ...
                        <div class="col-md-6 bg-dark-input">
                            <label class="form-label text-white text-opacity-50">اسم الخدمة: <span
                        ...
                        <!-- Company Size -->
                        <div class="col-md-6 bg-dark-input">
                            <label class="form-label text-white text-opacity-50">تحميل أيقونة جديدة <span
                                    class="text-danger">*</span></label>
                            <input name="image" type="file" class="form-control" id="companySize">
                        </div>

                        <div class="col-12 bg-dark-input">
                            <label class="form-label text-white text-opacity-50">وصف الخدمة :</label>
                            <textarea class="form-control" name="descreption"
                                rows="3">{{ $service->descreption }}</textarea>
                        </div>

                        <!-- Button -->
                        <div class="col-12 bg-dark-input">
                            <div class="d-grid">
                                <button class="btn btn-lg " style="background-color: #afa939;">حفظ التغيرات :</button>
                            </div>
