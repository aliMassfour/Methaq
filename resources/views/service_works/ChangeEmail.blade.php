        ...
        <div class="col-12 mt-5">
            <center>
                <div class="bg-dark rounded-3 p-4 p-sm-5 position-relative w-50" dir="rtl">
                    ...
                    <h3 class="mb-3 text-white">تعديل البريد الإلكتروني :</h3>

                    <!-- Form START -->
                    <form class="row g-3 position-relative" action="{{ route('email.save') }}" method="POST">
                        @csrf
                        @method('PUT')
                        <!-- service name -->
                        <div class="col-md-12 bg-dark-input">
                            <label class="form-label text-white text-opacity-50">الايميل الجديد : <span
                        ...
                        <!-- Company Size -->
                        <div class="col-md-12 bg-dark-input">
                            <label class="form-label text-white text-opacity-50">أدخل كلمة المرور : <span
                                    class="text-danger">*</span></label>
                            <input name="password" type="password" class="form-control" id="companySize">
                        </div>
