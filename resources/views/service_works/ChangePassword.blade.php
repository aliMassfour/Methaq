...
<div class="row">
    <div class="col-12 mt-5">
        <center>
            <div class="bg-dark rounded-3 p-4 p-sm-5 position-relative w-50" dir="rtl">
                ...
                <!-- SVG decoration -->
                <figure class="position-absolute top-0  mt-5 " style="float: left;">
                ...
                <h3 class="mb-3 text-white">تعديل كلمة المرور :</h3>

                <!-- Form START -->
                <form class="row g-3 position-relative" action="{{ route('password.save') }} " method="post">
                    @csrf
                    @method('PUT')
                    <div class="col-md-12 bg-dark-input">
                        <label class="form-label text-white text-opacity-50">أدخل كلمة المرور القديمة : <span
                                class="text-danger">*</span></label>
                        <input name="current_password" type="password" class="form-control" id="firstName">
                    </div>


                    <div class="col-md-12 bg-dark-input">
                        <label class="form-label text-white text-opacity-50">أدخل كلمة المرور الجديدة: <span
                                class="text-danger">*</span></label>
                        <input name="new_password" type="password" class="form-control" id="companySize">
                    </div>

                    <div class="col-md-12 bg-dark-input">
                        <label class="form-label text-white text-opacity-50">تأكيد كلمة المرور :<span
                                class="text-danger">*</span></label>
                        <input type="password" class="form-control" id="companySize">
                    </div>

                    <!-- Button -->
                    <div class="col-12 bg-dark-input">
                        <div class="d-grid">
                            <button class="btn btn-lg " style="background-color: #afa939;">حفظ التغغيرات
                                :</button>
                        </div>
